// ======================================================================
// Design05.v generated from TopDesign.cysch
// 09/18/2014 at 10:19
...
`else
`define CY_BLK_DIR "C:\Program Files (x86)\Cypress\PSoC Creator\3.0\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\BShiftReg_v2_30"
`include "C:\Program Files (x86)\Cypress\PSoC Creator\3.0\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\BShiftReg_v2_30\BShiftReg_v2_30.v"
`endif

// ShiftReg_v2_30(ControlRegUsageReplacemetString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DefSi=0, Direction=1, FifoSize=4, InterruptSource=0, Length=10, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, UseInputFifo=false, UseInterrupt=false, UseOutputFifo=false, UseShiftIn=true, UseShiftOut=true, VerilogSectionReplacementString=sC16, CY_COMPONENT_NAME=ShiftReg_v2_30, CY_CONTROL_FILE=<:default:>, CY_FITTER_NAME=ShiftReg_1, CY_INSTANCE_SHORT_NAME=ShiftReg_1, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=30, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=cydsfit No Version Information Found, INSTANCE_NAME=ShiftReg_1, )
...
// ShiftReg_v2_30(ControlRegUsageReplacemetString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DefSi=0, Direction=1, FifoSize=4, InterruptSource=0, Length=15, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, UseInputFifo=false, UseInterrupt=false, UseOutputFifo=false, UseShiftIn=true, UseShiftOut=true, VerilogSectionReplacementString=sC16, CY_COMPONENT_NAME=ShiftReg_v2_30, CY_CONTROL_FILE=<:default:>, CY_FITTER_NAME=ShiftReg_2, CY_INSTANCE_SHORT_NAME=ShiftReg_2, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=30, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=cydsfit No Version Information Found, INSTANCE_NAME=ShiftReg_2, )
...
// ShiftReg_v2_30(ControlRegUsageReplacemetString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DefSi=0, Direction=1, FifoSize=4, InterruptSource=0, Length=15, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, UseInputFifo=false, UseInterrupt=false, UseOutputFifo=false, UseShiftIn=true, UseShiftOut=true, VerilogSectionReplacementString=sC16, CY_COMPONENT_NAME=ShiftReg_v2_30, CY_CONTROL_FILE=<:default:>, CY_FITTER_NAME=ShiftReg_3, CY_INSTANCE_SHORT_NAME=ShiftReg_3, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=30, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=cydsfit No Version Information Found, INSTANCE_NAME=ShiftReg_3, )
...
module top ;
    ...
    defparam ShiftReg_1.Length = 10;

    ShiftReg_v2_30_1 ShiftReg_2 (
        .shift_in(Net_60),
        .load(1'b0),
        .store(1'b0),
        .clock(Net_45),
    ...
    defparam ShiftReg_2.Length = 15;

    ShiftReg_v2_30_2 ShiftReg_3 (
        .shift_in(Net_35),
        .load(1'b0),
        .store(1'b0),
        .clock(Net_45),
	...
	wire [0:0] tmpOE__LATCH_net;
	wire [0:0] tmpIO_0__LATCH_net;
	wire [0:0] tmpINTERRUPT_0__LATCH_net;
	electrical [0:0] tmpSIOVREF__LATCH_net;

	cy_psoc3_pins_v1_10
		#(.id("be4bfc8c-6dbc-4508-bf4e-f7776da7b09c"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		LATCH
		 (.oe(tmpOE__LATCH_net),
		  .y({1'b0}),
		  .fb({Net_104}),
		  .io({tmpIO_0__LATCH_net[0:0]}),
		  .siovref(tmpSIOVREF__LATCH_net),
		  .interrupt({tmpINTERRUPT_0__LATCH_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LATCH_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__VFD_CLOCK_net;
	wire [0:0] tmpIO_0__VFD_CLOCK_net;
	wire [0:0] tmpINTERRUPT_0__VFD_CLOCK_net;
	electrical [0:0] tmpSIOVREF__VFD_CLOCK_net;

	cy_psoc3_pins_v1_10
		#(.id("dee7ef11-020a-4ace-a156-d5a046a94549"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .width(1))
		VFD_CLOCK
		 (.oe(tmpOE__VFD_CLOCK_net),
		  .y({1'b0}),
		  .fb({Net_45}),
		  .io({tmpIO_0__VFD_CLOCK_net[0:0]}),
		  .siovref(tmpSIOVREF__VFD_CLOCK_net),
		  .interrupt({tmpINTERRUPT_0__VFD_CLOCK_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__VFD_CLOCK_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


    assign Net_101 = ~Net_104;

    ADC_DelSig_v3_0_3 ADC_DelSig_1 (
        .vplus(Net_106),
        .vminus(Net_107),
        .soc(1'b1),
        .eoc(Net_109),
