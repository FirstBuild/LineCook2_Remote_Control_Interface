...
#define ShiftReg_3_USE_OUTPUT_FIFO    (0u)
#define ShiftReg_3_SR_SIZE            (15u)
...
void  ShiftReg_3_WriteRegValue(uint16 shiftData) \
                                                                ;
uint16 ShiftReg_3_ReadRegValue(void) ;
uint8    ShiftReg_3_GetFIFOStatus(uint8 fifoId)           ;

#if(0u != ShiftReg_3_USE_INPUT_FIFO)
    cystatus ShiftReg_3_WriteData(uint16 shiftData) \
                                                                ;
#endif /* (0u != ShiftReg_3_USE_INPUT_FIFO) */

#if(0u != ShiftReg_3_USE_OUTPUT_FIFO)
    uint16 ShiftReg_3_ReadData(void) ;
...
#define ShiftReg_3_SR_MASK    (0x7FFFu) /* Unsigned is added to parameter */
...
#define ShiftReg_3_SHIFT_REG_CAPTURE_PTR    ( (reg8 *) \
    ...
    #define ShiftReg_3_OUT_FIFO_VAL_LSB_PTR       ( (reg16 *) \
        ...
        #define ShiftReg_3_IN_FIFO_VAL_LSB_PTR        ( (reg16 *) \
                                  ShiftReg_3_bSR_sC16_BShiftRegDp_u0__16BIT_F0_REG )

        #define ShiftReg_3_SHIFT_REG_LSB_PTR          ( (reg16 *) \
                                  ShiftReg_3_bSR_sC16_BShiftRegDp_u0__16BIT_A0_REG )

        #define ShiftReg_3_SHIFT_REG_VALUE_LSB_PTR    ( (reg16 *) \
                                  ShiftReg_3_bSR_sC16_BShiftRegDp_u0__16BIT_A1_REG )

        #define ShiftReg_3_OUT_FIFO_VAL_LSB_PTR       ( (reg16 *) \
                                  ShiftReg_3_bSR_sC16_BShiftRegDp_u0__16BIT_F1_REG )
    ...
    #else /* 32bit - ShiftReg */
        #define ShiftReg_3_IN_FIFO_VAL_LSB_PTR        ( (reg32 *) \
                                  ShiftReg_3_bSR_sC16_BShiftRegDp_u0__32BIT_F0_REG )

        #define ShiftReg_3_SHIFT_REG_LSB_PTR          ( (reg32 *) \
                                  ShiftReg_3_bSR_sC16_BShiftRegDp_u0__32BIT_A0_REG )

        #define ShiftReg_3_SHIFT_REG_VALUE_LSB_PTR    ( (reg32 *) \
                                  ShiftReg_3_bSR_sC16_BShiftRegDp_u0__32BIT_A1_REG )

        #define ShiftReg_3_OUT_FIFO_VAL_LSB_PTR       ( (reg32 *) \
                                  ShiftReg_3_bSR_sC16_BShiftRegDp_u0__32BIT_F1_REG )
