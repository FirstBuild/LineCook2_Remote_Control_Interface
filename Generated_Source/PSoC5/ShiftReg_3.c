...
{
    CY_SET_REG16(ShiftReg_3_SHIFT_REG_LSB_PTR, shiftData);
}
    ...
    *******************************************************************************/
                                                                         ...
                                                                         
    {
        ...
        {
            CY_SET_REG16(ShiftReg_3_IN_FIFO_VAL_LSB_PTR, shiftData);
    ...
    *******************************************************************************/
    ...
    {
        return(CY_GET_REG16(ShiftReg_3_OUT_FIFO_VAL_LSB_PTR));
    }
...
uint16 ShiftReg_3_ReadRegValue(void) 
{
    ...
    {
        (void) CY_GET_REG16(ShiftReg_3_OUT_FIFO_VAL_LSB_PTR);
    }
    ...
    /* Read output FIFO */
    result  = CY_GET_REG16(ShiftReg_3_OUT_FIFO_VAL_LSB_PTR);
    
    #if(0u != (ShiftReg_3_SR_SIZE % 8u))
        result &= ((uint16) ShiftReg_3_SR_MASK);
