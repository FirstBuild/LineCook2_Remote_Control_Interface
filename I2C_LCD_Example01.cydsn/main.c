...
/* Stores the state of the display */
...
CY_ISR(FlipLcdIsr)
{
    ...
    ***********************************************************************/
    ...
    /* Clear interupt flag for this port */
...
void main()
{
    ...
    ***********************************************************************/
    ...
    {
        /* Display the custom character specified by 'i' */
    ...
    * I2C_LCD_WriteData().
    ***********************************************************************/
    /* Set position to the start of the second row of the LCD module */
    I2C_LCD_Position(ROW_ONE, COLUMN_ZERO);
    
    /* Display the entire string of custom characters */
    I2C_LCD_PrintString(string);
    ...
    ***********************************************************************/
    ...
    while(1u)
    {
        /* Analyze the LCD state variable and set the state appropriately */
        if(NORMAL_STATE == lcdState)
        {
